  ...
  return (
    <div className="container__divisas">
        ...
        <div className="panel_change">
          ...
          <div className="change">
            <div className="change_divisa">
              <div className="compra1"><h3>Compra: <small>{Sales.purchaseRate}</small></h3></div>
              <div className="line"><small>{Sales.currencyCode + ' ' + Sales.instrumentDescription}</small></div>
              <div className="venta1"><h3>Venta: <small>{Sales.saleRate}</small></h3></div>
            </div>
            <ul>
              <li className="dolar1">
      ...
      <div className="splash">
        ...
        <h2>¿Te gustaría estar siempre al tanto?</h2><br />
        <span>Recibe actualizaciones periódicamente sobre temas de interés financiero y del mercado de compra y venta de divisas en general con nuestro newsletter.</span>
      
        <button className="button_splash"><a href="https://keap.app/contact-us/7331125519563925">¡Inscríbete aquí!</a></button>
      </div><br /><br />
    </div>
  );
};
